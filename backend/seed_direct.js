...
async function seed() {
  try {
    const mongoUri = process.env.MONGODB_URI || "mongodb://localhost:27017/heriverse";
    ...
    const docs = await Place.insertMany(samplePlaces);
    console.log(`Successfully seeded ${docs.length} places directly in MongoDB Compass.`);
